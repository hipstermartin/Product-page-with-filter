...
<body>    
    ...
    <div class="container">
        <div class="row">
        <nav class="navbar navbar-fixed-top" style="background-color:#2874f0;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="image/logo.png" style="Height:30px; top:10px">
                    </a>
                </div>
                
                <div class="collapse navbar-collapse" id="myNavbar" style="padding-bottom: 15px">
                  <form class="navbar-form navbar-left">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="hove"><a href="" style="color: #FFF; font-size:20px"><span><i class="fa fa-shopping-cart"></i></span> Cart<span class="badge"></span></a></li>
                        <li><a href="" style="color: #FFF; font-size:20px"><span><i class="fa fa-gear"></i></span> Settings</a></li>
                        <li><a href="" style="color: #FFF; font-size:20px"><span><i class="fa fa-sign-in"></i></span> Login</a></li>
                    </ul>
                </div>
            </div>
        </nav></br>
